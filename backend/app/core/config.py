...
class Settings(BaseSettings):
    ...
    SESSION_PREDICTION_WINDOW_SIZE: int = 12
    SESSION_STABLE_MIN_HISTORY: int = 5
    SESSION_STABLE_MIN_COUNT: int = 8
    SESSION_COMMIT_COOLDOWN_SECONDS: float = 0.75
    SESSION_AUTO_SPACE_TIMEOUT_SECONDS: float = 3.0
